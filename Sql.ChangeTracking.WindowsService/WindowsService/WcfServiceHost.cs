...
namespace SqlChangeTrackingProducerConsumer
{
    public static class WcfServiceHost
    {
        ...
        //private static ChangeTrackingAppSettings settings = AutoConfig.Map<ChangeTrackingAppSettings>();
        ...
        public static ServiceHost GetServiceHost(IChangeTrackingSubscriptions service)
        {
            ...
            Uri[] adrbase = { new Uri(ServiceUrl.SqlTrackingWcfServiceAddress) };
            ...
            _ServiceHost.AddServiceEndpoint(typeof(IChangeTrackingSubscriptions), tcpBinding, ServiceUrl.SqlTrackingWcfServiceAddress);
